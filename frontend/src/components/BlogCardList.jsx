...
const BlogCardList = ({ blog }) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-700 dark:border-gray-600 flex flex-col md:flex-row md:gap-10 p-5 rounded-2xl mt-6 shadow-lg border  transition-all">
            <div>
            <img src={blog?.thumbnail} loading="lazy" alt="thumbnail" className='rounded-lg md:w-[300px] hover:scale-105 transition-all' />
            ...
            <div>
                ...
                <Button onClick={() => navigate(`/blogs/${blog?.id}`)} className="mt-4 px-4 py-2 rounded-lg text-sm ">
                    Read More
                </Button>
            </div>
        </div>
